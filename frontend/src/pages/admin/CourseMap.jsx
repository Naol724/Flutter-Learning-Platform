...
const AdminCourseMap = () => {
  ...
  useEffect(() => {
    // Expand first phase by default when phases are loaded
          ...
          {phases.map((phase) => {
            ...
            return (
              <div key={phase.id} className="bg-white rounded-lg shadow-sm border border-gray-200">
                {/* Phase Header */}
                <div
                  className="p-3 sm:p-4 sm:p-6 cursor-pointer hover:bg-gray-50 transition-colors flex items-center justify-between"
